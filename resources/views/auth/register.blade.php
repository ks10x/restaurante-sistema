        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="password" name="password" required class="w-full bg-slate-50 border @error('password') border-red-500 @else border-slate-200 @enderror rounded-2xl p-4 text-slate-900 navy-border outline-none transition-all">
                </div>
                <div>
                    <label class="block text-slate-500 text-xs font-bold uppercase mb-2">Confirmar Senha</label>
                    <input type="password" name="password_confirmation" required class="w-full bg-slate-50 border border-slate-200 rounded-2xl p-4 text-slate-900 navy-border outline-none transition-all">
                </div>
            </div>
