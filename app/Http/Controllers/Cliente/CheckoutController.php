        ...
        try {
            ...
            return DB::transaction(function () use ($validated, $user, $pagarme) {
                ...
                $itensPronto = $itens->map(function ($item) use (&$subtotal) {
                    ...
                    abort_if(! $prato->disponivel, 422, "Prato {$prato->nome} indisponivel.");
            ...
            return response()->json([
                'success' => false,
                'message' => collect($e->errors())->flatten()->first() ?: 'Revise os dados enviados.',
                'errors'  => $e->errors(),
            ], 422);
        } catch (\Throwable $e) {
            ...
            return response()->json([
                'success' => false,
                'message' => $e->getMessage() ?: 'Nao foi possivel processar o pagamento agora.',
            ], 500);
        }
    }
}
